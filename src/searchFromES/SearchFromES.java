...
public class SearchFromES {
	...
	public static void  boolQuery(Client client,String target){
		SearchRequestBuilder responsebuilder = client.prepareSearch("crawler").setTypes("website");
		SearchResponse myresponse = responsebuilder.setQuery(
	 ...
	 * 模糊查询
	 */
	public static void fuzzyQuery( Client client,String target) {
		SearchRequestBuilder responsebuilder = client.prepareSearch("crawler").setTypes("website");
		SearchResponse myresponse = responsebuilder.setQuery(
	...
	public static void aggSearch(Client client, String aggField) {
	...
	public static void aggSearch3(Client client, String target, String channel_name) {
		...
		response = sbuilder.setSize(100) // 显示20条
				...
				.addHighlightedField("content").setHighlighterPreTags("<span style=\"color:red\">") // 设置高亮域前置标签
